...
const joao = new NewUser("Hanna", 20);
console.log(joao);
// 3 - campo readonly
class Car {
    constructor(name) {
...
const hannakelly = new Person("Hanna", "Kelly");
console.log(hannakelly.fullName);
// 8 - setter
class Coords {
    set fillX(x) {
        if (x === 0) {
...
const pessoa = new myClass("Hanna");
...
const newObjAbstract = new AbstractExample("Hanna");
